...
/* ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Bible Books and Chapters ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ */
const BIBLE_BOOKS = [
...
/* ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ Faith Pathway types ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ */
...
export function HomeScreen({ onNavigate, onOpenAI }: { onNavigate?: (tab: TabId) => void; onOpenAI?: () => void }) {
  ...
  // Pre-load all today's chapters in ESV â real human audio via ESV.org
  useEffect(() => {
    if (!heroKey) return;
    setHeroLoading(true);
  ...
  return (
    <div className="screen-container">
      ...
      <div style={{ padding: '0 24px 0' }}>
        ...
        {/* Book Cards â comfort persona surfaces recommended books */}
        ...
        {/* ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ FAITH PATHWAY CARD ÃÂÃÂ¢ÃÂÃÂÃÂÃÂÃÂÃÂ¢ÃÂÃÂÃÂÃÂ for new_returning persona */}
