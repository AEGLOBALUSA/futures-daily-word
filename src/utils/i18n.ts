...
const UI: Translations = {
  ...
  j_handoff_done_body: { en: 'You are loved, and you are new in Christ. Want a person with you for what comes next? A Connect Group is a small group that meets to grow together. Ask about one at your campus this Sunday.', es: 'Dios te ama, y en Cristo tienes vida nueva. \u00bfQuieres tener a alguien contigo para lo que viene? Un Grupo de Conexi\u00f3n es un grupo peque\u00f1o que se re\u00fane para crecer juntos. Pregunta por uno en tu campus este domingo.', pt: 'Deus te ama, e em Cristo voc\u00ea tem vida nova. Quer ter algu\u00e9m com voc\u00ea para o que vem a seguir? Um Grupo de Conex\u00e3o \u00e9 um grupo pequeno que se re\u00fane para crescer juntos. Pergunte sobre um no seu campus neste domingo.', id: 'Anda dikasihi, dan Anda baru di dalam Kristus. Ingin ditemani seseorang untuk langkah berikutnya? Kelompok Koneksi adalah kelompok kecil yang berkumpul untuk bertumbuh bersama. Tanyakan tentang itu di campus Anda hari Minggu ini.' },
