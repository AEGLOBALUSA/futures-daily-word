...
const UI: Translations = {
  ...
  j_close_identity_3: { en: 'You are new in Christ.', es: 'Eres nuevo en Cristo.', pt: 'Voc\u00ea \u00e9 novo em Cristo.', id: 'Anda baru di dalam Kristus.' },
  ...
  j_handoff_body: { en: "You don't have to do this on your own. A Connect Group is a small group that meets to grow together. Ask about one at your campus this Sunday, and see what your campus is sharing here.", es: 'No tienes que hacer esto solo. Un Grupo de Conexi\u00f3n es un grupo peque\u00f1o que se re\u00fane para crecer juntos. Pregunta por uno en tu campus este domingo, y mira lo que tu campus est\u00e1 compartiendo aqu\u00ed.', pt: 'Voc\u00ea n\u00e3o precisa fazer isso sozinho. Um Grupo de Conex\u00e3o \u00e9 um grupo pequeno que se re\u00fane para crescer juntos. Pergunte sobre um no seu campus neste domingo, e veja o que o seu campus est\u00e1 compartilhando aqui.', id: 'Anda tidak perlu melakukan ini sendirian. Connect Group adalah kelompok kecil yang berkumpul untuk bertumbuh bersama. Tanyakan tentang itu di campus Anda hari Minggu ini, dan lihat apa yang sedang dibagikan campus Anda di sini.' },
  ...
  j_handoff_done_body: { en: 'You are loved, and you are new in Christ. Want a person with you for what comes next? A Connect Group is a small group that meets to grow together. Ask about one at your campus this Sunday.', es: 'Eres amado, y eres nuevo en Cristo. \u00bfQuieres tener a alguien contigo para lo que viene? Un Grupo de Conexi\u00f3n es un grupo peque\u00f1o que se re\u00fane para crecer juntos. Pregunta por uno en tu campus este domingo.', pt: 'Voc\u00ea \u00e9 amado, e \u00e9 novo em Cristo. Quer ter algu\u00e9m com voc\u00ea para o que vem a seguir? Um Grupo de Conex\u00e3o \u00e9 um grupo pequeno que se re\u00fane para crescer juntos. Pergunte sobre um no seu campus neste domingo.', id: 'Anda dikasihi, dan Anda baru di dalam Kristus. Ingin ditemani seseorang untuk langkah berikutnya? Connect Group adalah kelompok kecil yang berkumpul untuk bertumbuh bersama. Tanyakan tentang itu di campus Anda hari Minggu ini.' },
  ...
  greeting_milestone_label: { en: 'Milestone Reached', es: 'Hito alcanzado', pt: 'Marco alcan\u00e7ado', id: 'Pencapaian Tercapai' },
  greeting_milestone_streak: { en: 'You\'ve got a {x}-day streak', es: 'Llevas una racha de {x} d\u00edas', pt: 'Voc\u00ea tem uma sequ\u00eancia de {x} dias', id: 'Kamu memiliki {x} hari beruntun' },
  greeting_milestone_keep: { en: 'Keep the momentum going.', es: 'Mant\u00e9n el impulso.', pt: 'Mantenha o impulso.', id: 'Terus pertahankan momentumnya.' },
  ...
  congregation_sheet_title: { en: 'Which church are you with?', es: '¿Con qué iglesia estás?', pt: 'Com qual igreja você está?', id: 'Anda bersama gereja mana?' },
  congregation_sheet_sub: { en: 'Each has its own Sunday message and notes.', es: 'Cada una tiene su propio mensaje y notas del domingo.', pt: 'Cada uma tem sua própria mensagem e notas de domingo.', id: 'Masing-masing punya khotbah dan catatan Minggu sendiri.' },
  congregation_sheet_footer: { en: 'You can change this any time from the notes page.', es: 'Puedes cambiarlo cuando quieras desde la página de notas.', pt: 'Você pode mudar isso a qualquer momento na página de notas.', id: 'Anda bisa mengubahnya kapan saja dari halaman catatan.' },
  congregation_change: { en: 'Change church', es: 'Cambiar iglesia', pt: 'Mudar igreja', id: 'Ganti gereja' },
  ...
  // ── STUDY SOURCES (Settings, pastor_leader only) ──
  study_sources_header: { en: 'STUDY SOURCES', es: 'FUENTES DE ESTUDIO', pt: 'FONTES DE ESTUDO', id: 'SUMBER STUDI' },
  study_sources_intro: { en: 'Cross-references, commentaries, lexicons and place data used in study tools come from these public-domain and Creative Commons sources.', es: 'Las referencias cruzadas, los comentarios, los l\u00e9xicos y los datos de lugares usados en las herramientas de estudio provienen de estas fuentes de dominio p\u00fablico y Creative Commons.', pt: 'As refer\u00eancias cruzadas, os coment\u00e1rios, os l\u00e9xicos e os dados de lugares usados nas ferramentas de estudo v\u00eam destas fontes de dom\u00ednio p\u00fablico e Creative Commons.', id: 'Referensi silang, tafsiran, leksikon, dan data tempat yang digunakan dalam alat studi berasal dari sumber domain publik dan Creative Commons berikut.' },
  study_sources_loading: { en: 'Loading sources\u2026', es: 'Cargando fuentes\u2026', pt: 'Carregando fontes\u2026', id: 'Memuat sumber\u2026' },
  study_sources_none: { en: 'No study sources are loaded yet.', es: 'A\u00fan no hay fuentes de estudio cargadas.', pt: 'Ainda n\u00e3o h\u00e1 fontes de estudo carregadas.', id: 'Belum ada sumber studi yang dimuat.' },
  study_sources_share_alike: { en: 'Share-alike: anything built from this source stays under the same licence.', es: 'Compartir igual: todo lo que se construya a partir de esta fuente permanece bajo la misma licencia.', pt: 'Compartilhamento pela mesma licen\u00e7a: tudo o que for constru\u00eddo a partir desta fonte permanece sob a mesma licen\u00e7a.', id: 'Berbagi serupa: apa pun yang dibuat dari sumber ini tetap berada di bawah lisensi yang sama.' },
  study_sources_records: { en: 'records', es: 'registros', pt: 'registros', id: 'catatan' },
  // ── PASTOR ACCOUNT — change password (Study & Preach plan, Phase 4) ──
  ...
  preach_prep_go: { en: 'Go', es: 'Ir', pt: 'Ir', id: 'Buka' },
  preach_prep_text_label: { en: 'Passage text', es: 'Texto del pasaje', pt: 'Texto da passagem', id: 'Teks bagian' },
  preach_prep_loading: { en: 'Loading\u2026', es: 'Cargando\u2026', pt: 'Carregando\u2026', id: 'Memuat\u2026' },
  preach_prep_text_empty: { en: 'Text unavailable right now.', es: 'Texto no disponible por el momento.', pt: 'Texto indispon\u00edvel no momento.', id: 'Teks belum tersedia saat ini.' },
  preach_prep_crossrefs_label: { en: 'Cross-references', es: 'Referencias cruzadas', pt: 'Refer\u00eancias cruzadas', id: 'Referensi silang' },
  preach_prep_verse_label: { en: 'Verse', es: 'Vers\u00edculo', pt: 'Vers\u00edculo', id: 'Ayat' },
  preach_prep_more: { en: 'More', es: 'M\u00e1s', pt: 'Mais', id: 'Lainnya' },
  preach_prep_crossrefs_empty: { en: 'No cross-references yet for this passage.', es: 'A\u00fan no hay referencias cruzadas para este pasaje.', pt: 'Ainda n\u00e3o h\u00e1 refer\u00eancias cruzadas para esta passagem.', id: 'Belum ada referensi silang untuk bagian ini.' },
  preach_prep_commentary_label: { en: 'Commentaries', es: 'Comentarios', pt: 'Coment\u00e1rios', id: 'Tafsiran' },
  preach_prep_summarise: { en: 'Summarise', es: 'Resumir', pt: 'Resumir', id: 'Ringkas' },
  preach_prep_summarising: { en: 'Summarising\u2026', es: 'Resumiendo\u2026', pt: 'Resumindo\u2026', id: 'Meringkas\u2026' },
  preach_prep_commentary_empty: { en: 'No commentary available for this passage yet.', es: 'A\u00fan no hay comentarios disponibles para este pasaje.', pt: 'Ainda n\u00e3o h\u00e1 coment\u00e1rios dispon\u00edveis para esta passagem.', id: 'Belum ada tafsiran yang tersedia untuk bagian ini.' },
  preach_prep_add_outline: { en: 'Add to outline', es: 'A\u00f1adir al esquema', pt: 'Adicionar ao esbo\u00e7o', id: 'Tambahkan ke kerangka' },
  preach_prep_words_label: { en: 'Key words', es: 'Palabras clave', pt: 'Palavras-chave', id: 'Kata kunci' },
  preach_prep_words_empty: { en: 'No Greek or Hebrew word data for this passage yet.', es: 'A\u00fan no hay datos de palabras en griego o hebreo para este pasaje.', pt: 'Ainda n\u00e3o h\u00e1 dados de palavras em grego ou hebraico para esta passagem.', id: 'Belum ada data kata Yunani atau Ibrani untuk bagian ini.' },
  preach_prep_places_label: { en: 'Places', es: 'Lugares', pt: 'Lugares', id: 'Tempat' },
  preach_prep_places_empty: { en: 'No places identified in this passage.', es: 'No se identificaron lugares en este pasaje.', pt: 'Nenhum lugar identificado nesta passagem.', id: 'Tidak ada tempat yang teridentifikasi dalam bagian ini.' },
  preach_prep_people_label: { en: 'People', es: 'Personas', pt: 'Pessoas', id: 'Orang' },
  preach_prep_people_empty: { en: 'No people identified in this passage.', es: 'No se identificaron personas en este pasaje.', pt: 'Nenhuma pessoa identificada nesta passagem.', id: 'Tidak ada orang yang teridentifikasi dalam bagian ini.' },
  preach_prep_illustrations_label: { en: 'Illustrations', es: 'Ilustraciones', pt: 'Ilustra\u00e7\u00f5es', id: 'Ilustrasi' },
  preach_prep_illustrations_empty: { en: 'No illustrations matched to this passage yet.', es: 'A\u00fan no hay ilustraciones relacionadas con este pasaje.', pt: 'Ainda n\u00e3o h\u00e1 ilustra\u00e7\u00f5es correspondentes a esta passagem.', id: 'Belum ada ilustrasi yang cocok untuk bagian ini.' },
  preach_publish_title: { en: 'PUBLISH', es: 'PUBLICAR', pt: 'PUBLICAR', id: 'TERBITKAN' },
  preach_publish_sign_in: { en: "Sign in at Settings \u2192 Pastor account to publish this week's message.", es: 'Inicia sesi\u00f3n en Ajustes \u2192 Cuenta de pastor para publicar el mensaje de esta semana.', pt: 'Entre em Configura\u00e7\u00f5es \u2192 Conta de pastor para publicar a mensagem desta semana.', id: 'Masuk di Pengaturan \u2192 Akun pendeta untuk menerbitkan pesan minggu ini.' },
  preach_publish_unavailable: { en: "Publishing isn't set up for this account yet.", es: 'La publicaci\u00f3n a\u00fan no est\u00e1 configurada para esta cuenta.', pt: 'A publica\u00e7\u00e3o ainda n\u00e3o est\u00e1 configurada para esta conta.', id: 'Penerbitan belum diatur untuk akun ini.' },
  preach_publish_load_error: { en: 'Could not load the publish form.', es: 'No se pudo cargar el formulario de publicaci\u00f3n.', pt: 'N\u00e3o foi poss\u00edvel carregar o formul\u00e1rio de publica\u00e7\u00e3o.', id: 'Formulir penerbitan tidak dapat dimuat.' },
  preach_publish_youtube_ph: { en: 'YouTube link for this week (optional)', es: 'Enlace de YouTube de esta semana (opcional)', pt: 'Link do YouTube desta semana (opcional)', id: 'Tautan YouTube minggu ini (opsional)' },
  preach_publish_ai_tidy: { en: 'Let AI tidy the formatting', es: 'Dejar que la IA ordene el formato', pt: 'Deixar a IA organizar a formata\u00e7\u00e3o', id: 'Biarkan AI merapikan format' },
  preach_publish_preview: { en: 'Preview', es: 'Vista previa', pt: 'Pr\u00e9-visualizar', id: 'Pratinjau' },
  preach_publish_preview_error: { en: 'Could not build the preview.', es: 'No se pudo generar la vista previa.', pt: 'N\u00e3o foi poss\u00edvel gerar a pr\u00e9-visualiza\u00e7\u00e3o.', id: 'Pratinjau tidak dapat dibuat.' },
  preach_publish_nothing_to_preview: { en: 'Nothing to preview yet \u2014 fill in the outline first.', es: 'Nada que previsualizar todav\u00eda \u2014 completa primero el esquema.', pt: 'Nada para pr\u00e9-visualizar ainda \u2014 preencha o esbo\u00e7o primeiro.', id: 'Belum ada yang bisa dipratinjau \u2014 isi kerangka terlebih dahulu.' },
  preach_publish_send: { en: 'Send to Sunday', es: 'Enviar para el domingo', pt: 'Enviar para domingo', id: 'Kirim untuk Minggu' },
  preach_publish_post_campus: { en: 'Post to campus corner', es: 'Publicar en el rinc\u00f3n del campus', pt: 'Publicar no espa\u00e7o do campus', id: 'Kirim ke sudut kampus' },
  preach_publish_confirm: { en: 'Confirm', es: 'Confirmar', pt: 'Confirmar', id: 'Konfirmasi' },
  preach_publish_warning: { en: 'This publishes to the congregation immediately.', es: 'Esto se publica de inmediato para la congregaci\u00f3n.', pt: 'Isso ser\u00e1 publicado imediatamente para a congrega\u00e7\u00e3o.', id: 'Ini akan langsung diterbitkan untuk jemaat.' },
  preach_publish_submit_error: { en: 'Could not publish. Try again.', es: 'No se pudo publicar. Int\u00e9ntalo de nuevo.', pt: 'N\u00e3o foi poss\u00edvel publicar. Tente novamente.', id: 'Gagal menerbitkan. Coba lagi.' },
  preach_publish_success_sermon: { en: "Published \u2014 it's live on Sermon Notes.", es: 'Publicado \u2014 ya est\u00e1 disponible en Notas del serm\u00f3n.', pt: 'Publicado \u2014 j\u00e1 est\u00e1 dispon\u00edvel nas Notas do serm\u00e3o.', id: 'Diterbitkan \u2014 sudah tayang di Catatan Khotbah.' },
  preach_publish_success_campus: { en: 'Posted to the campus corner.', es: 'Publicado en el rinc\u00f3n del campus.', pt: 'Publicado no espa\u00e7o do campus.', id: 'Terkirim ke sudut kampus.' },
  preach_archive_search_ph: { en: 'Search past messages or a reference\u2026', es: 'Buscar mensajes anteriores o una referencia\u2026', pt: 'Buscar mensagens anteriores ou uma refer\u00eancia\u2026', id: 'Cari pesan sebelumnya atau sebuah referensi\u2026' },
  preach_archive_loading: { en: 'Loading past messages\u2026', es: 'Cargando mensajes anteriores\u2026', pt: 'Carregando mensagens anteriores\u2026', id: 'Memuat pesan sebelumnya\u2026' },
  preach_archive_empty: { en: 'No messages published yet.', es: 'A\u00fan no hay mensajes publicados.', pt: 'Ainda n\u00e3o h\u00e1 mensagens publicadas.', id: 'Belum ada pesan yang dipublikasikan.' },
  preach_archive_no_results: { en: 'No messages match your search.', es: 'Ning\u00fan mensaje coincide con tu b\u00fasqueda.', pt: 'Nenhuma mensagem corresponde \u00e0 sua busca.', id: 'Tidak ada pesan yang cocok dengan pencarian Anda.' },
  // ── PREACH workspace — outline builder + screen ──
  preach_field_title: { en: 'Title', es: 'T\u00edtulo', pt: 'T\u00edtulo', id: 'Judul' },
  preach_field_title_ph: { en: 'e.g. Grace That Multiplies', es: 'p. ej. Gracia que se multiplica', pt: 'ex.: Gra\u00e7a que se multiplica', id: 'mis. Anugerah yang Melipatgandakan' },
  preach_field_passage: { en: 'Passage', es: 'Pasaje', pt: 'Passagem', id: 'Bagian Alkitab' },
  preach_field_passage_ph: { en: 'e.g. Romans 8:1-11', es: 'p. ej. Romanos 8:1-11', pt: 'ex.: Romanos 8:1-11', id: 'mis. Roma 8:1-11' },
  preach_field_series: { en: 'Series', es: 'Serie', pt: 'S\u00e9rie', id: 'Seri' },
  preach_field_series_ph: { en: 'e.g. Multiply or Die', es: 'p. ej. Multiplicarse o morir', pt: 'ex.: Multiplicar ou morrer', id: 'mis. Melipatgandakan atau Mati' },
  preach_field_date: { en: 'Date', es: 'Fecha', pt: 'Data', id: 'Tanggal' },
  preach_field_speaker: { en: 'Speaker', es: 'Predicador', pt: 'Pregador', id: 'Pengkhotbah' },
  preach_field_speaker_ph: { en: "Who's preaching", es: 'Qui\u00e9n predica', pt: 'Quem vai pregar', id: 'Siapa yang berkhotbah' },
  preach_field_big_idea: { en: 'Big idea', es: 'Idea central', pt: 'Ideia central', id: 'Gagasan utama' },
  preach_field_big_idea_ph: { en: 'The one thing you want them to leave with', es: 'Lo \u00fanico que quieres que se lleven', pt: 'A \u00fanica coisa que voc\u00ea quer que eles levem', id: 'Satu hal yang ingin mereka bawa pulang' },
  preach_points_label: { en: 'Points', es: 'Puntos', pt: 'Pontos', id: 'Poin' },
  preach_point_heading_ph: { en: 'Point heading', es: 'T\u00edtulo del punto', pt: 'T\u00edtulo do ponto', id: 'Judul poin' },
  preach_point_body_ph: { en: "What you'll say", es: 'Qu\u00e9 vas a decir', pt: 'O que voc\u00ea vai dizer', id: 'Apa yang akan kamu sampaikan' },
  preach_add_point: { en: 'Add point', es: 'A\u00f1adir punto', pt: 'Adicionar ponto', id: 'Tambah poin' },
  preach_field_weekly_action: { en: 'Weekly action', es: 'Acci\u00f3n semanal', pt: 'A\u00e7\u00e3o semanal', id: 'Aksi mingguan' },
  preach_field_weekly_action_ph: { en: 'One thing to do this week', es: 'Una cosa para hacer esta semana', pt: 'Uma coisa para fazer esta semana', id: 'Satu hal untuk dilakukan minggu ini' },
  preach_seed_button: { en: 'Seed from my highlights', es: 'Sembrar desde mis destacados', pt: 'Semear a partir dos meus destaques', id: 'Isi dari sorotan saya' },
  preach_seed_empty: { en: 'File a highlight to sermon prep first', es: 'Primero env\u00eda un destacado a la preparaci\u00f3n del serm\u00f3n', pt: 'Primeiro envie um destaque para a prepara\u00e7\u00e3o do serm\u00e3o', id: 'Kirim dulu sorotan ke persiapan khotbah' },
  preach_framework_label: { en: 'Framework', es: 'Marco', pt: 'Estrutura', id: 'Kerangka' },
  preach_framework_none: { en: 'None', es: 'Ninguno', pt: 'Nenhum', id: 'Tidak ada' },
  preach_framework_from: { en: 'from {source}', es: 'de {source}', pt: 'de {source}', id: 'dari {source}' },
  preach_preview_heading: { en: 'Notes as the congregation will receive them', es: 'Notas tal como las recibir\u00e1 la congregaci\u00f3n', pt: 'Notas como a congrega\u00e7\u00e3o vai receb\u00ea-las', id: 'Catatan seperti yang akan diterima jemaat' },
  preach_preview_empty: { en: 'Nothing to preview yet', es: 'A\u00fan no hay nada para previsualizar', pt: 'Ainda n\u00e3o h\u00e1 nada para pr\u00e9-visualizar', id: 'Belum ada yang bisa dipratinjau' },
  preach_size_warning: { en: 'Some text was shortened to fit sync limits', es: 'Se acort\u00f3 parte del texto para respetar los l\u00edmites de sincronizaci\u00f3n', pt: 'Parte do texto foi encurtada para respeitar os limites de sincroniza\u00e7\u00e3o', id: 'Sebagian teks dipersingkat agar sesuai batas sinkronisasi' },
  preach_title: { en: 'Preach', es: 'Predicar', pt: 'Pregar', id: 'Berkhotbah' },
  preach_this_week: { en: 'THIS WEEK', es: 'ESTA SEMANA', pt: 'ESTA SEMANA', id: 'MINGGU INI' },
  preach_focus_placeholder: { en: 'What are you preaching through?', es: '\u00bfEn qu\u00e9 est\u00e1s predicando?', pt: 'Sobre o que voc\u00ea est\u00e1 pregando?', id: 'Apa yang sedang Anda khotbahkan?' },
  preach_open_congregation_notes: { en: "Open the congregation's notes", es: 'Abrir las notas de la congregaci\u00f3n', pt: 'Abrir as notas da congrega\u00e7\u00e3o', id: 'Buka catatan jemaat' },
  preach_no_sermon: { en: 'Nothing published for the congregation yet this week.', es: 'A\u00fan no se ha publicado nada para la congregaci\u00f3n esta semana.', pt: 'Ainda n\u00e3o h\u00e1 nada publicado para a congrega\u00e7\u00e3o esta semana.', id: 'Belum ada yang diterbitkan untuk jemaat minggu ini.' },
  preach_tab_prep: { en: 'Prep', es: 'Preparar', pt: 'Preparar', id: 'Persiapan' },
  preach_tab_outline: { en: 'Outline', es: 'Esquema', pt: 'Esbo\u00e7o', id: 'Kerangka' },
  ...
  // ── "Choose your path" (Ashley, 2 Sep 2026): one sheet, three doors, never a gate ──
  path_sheet_title: { en: 'Where are you today?', es: '¿Dónde estás hoy?', pt: 'Onde você está hoje?', id: 'Di mana Anda hari ini?' },
  ...
  path_arrival_comfort: { en: "You're in comfort. Just the scriptures. Nothing else is asked of you.", es: 'Estás en consuelo. Solo las Escrituras. Nada más se te pide.', pt: 'Você está em conforto. Só as Escrituras. Nada mais é pedido de você.', id: 'Anda berada di penghiburan. Hanya ayat-ayat. Tidak ada yang lain diminta dari Anda.' },
  path_arrival_signed_in: { en: 'Signed in as pastor', es: 'Sesión iniciada como pastor', pt: 'Conectado como pastor', id: 'Masuk sebagai pendeta' },
  path_arrival_sign_in: { en: 'Sign in for campus tools', es: 'Inicia sesión para las herramientas de campus', pt: 'Entre para as ferramentas do campus', id: 'Masuk untuk alat kampus' },
  path_arrival_dismiss: { en: 'Dismiss', es: 'Cerrar', pt: 'Fechar', id: 'Tutup' },
  pastor_study_eyebrow: { en: 'Pastor study', es: 'Estudio pastoral', pt: 'Estudo pastoral', id: 'Studi pendeta' },
  path_sheet_footer: { en: "Not a test. Not a form. Just where you're starting from.", es: 'No es una prueba. No es un formulario. Solo desde dónde empiezas.', pt: 'Não é um teste. Não é um formulário. Só de onde você está começando.', id: 'Bukan ujian. Bukan formulir. Hanya dari mana Anda memulai.' },
  path_new_head: { en: "I'm new to faith, or coming back", es: 'Soy nuevo en la fe, o estoy volviendo', pt: 'Sou novo na fé, ou estou voltando', id: 'Saya baru dalam iman, atau sedang kembali' },
  path_new_promise: { en: 'A 40-day journey. One short day at a time.', es: 'Un camino de 40 días. Un día corto a la vez.', pt: 'Uma jornada de 40 dias. Um dia curto de cada vez.', id: 'Perjalanan 40 hari. Satu hari singkat setiap kali.' },
  path_new_cta: { en: 'Start Day 1', es: 'Comenzar el Día 1', pt: 'Começar o Dia 1', id: 'Mulai Hari 1' },
  path_member_head: { en: "I'm part of Futures Church", es: 'Soy parte de Futures Church', pt: 'Faço parte da Futures Church', id: 'Saya bagian dari Futures Church' },
  path_member_promise: { en: "Today's reading with Ashley & Jane, already open.", es: 'La lectura de hoy con Ashley y Jane, ya abierta.', pt: 'A leitura de hoje com Ashley e Jane, já aberta.', id: 'Bacaan hari ini bersama Ashley & Jane, sudah terbuka.' },
  path_member_cta: { en: "Open today's reading", es: 'Abrir la lectura de hoy', pt: 'Abrir a leitura de hoje', id: 'Buka bacaan hari ini' },
  path_study_head: { en: 'I want to go deeper in the Word', es: 'Quiero profundizar en la Palabra', pt: 'Quero ir mais fundo na Palavra', id: 'Saya ingin lebih dalam di Firman' },
  path_study_promise: { en: 'Commentary, original languages, cross-references.', es: 'Comentarios, idiomas originales, referencias cruzadas.', pt: 'Comentários, línguas originais, referências cruzadas.', id: 'Komentar, bahasa asli, referensi silang.' },
  path_study_cta: { en: 'Open the study reading', es: 'Abrir la lectura de estudio', pt: 'Abrir a leitura de estudo', id: 'Buka bacaan studi' },
  path_leader_head: { en: "I'm a pastor and I teach and preach", es: 'Soy pastor y enseño y predico', pt: 'Sou pastor e ensino e prego', id: 'Saya seorang pendeta dan saya mengajar dan berkhotbah' },
  path_leader_promise: { en: 'Study tools and sermon prep. Pastors sign in for campus tools.', es: 'Herramientas de estudio y preparación de sermones. Los pastores inician sesión para las herramientas de campus.', pt: 'Ferramentas de estudo e preparação de sermões. Pastores entram para as ferramentas do campus.', id: 'Alat studi dan persiapan khotbah. Pendeta masuk untuk alat kampus.' },
  path_leader_cta: { en: 'Open my study', es: 'Abrir mi estudio', pt: 'Abrir meu estudo', id: 'Buka studi saya' },
  path_comfort_head: { en: "I'm going through something hard", es: 'Estoy pasando por algo difícil', pt: 'Estou passando por algo difícil', id: 'Saya sedang melewati masa yang sulit' },
  path_comfort_promise: { en: 'Comfort scriptures. Nothing else asked of you.', es: 'Escrituras de consuelo. Nada más se te pide.', pt: 'Escrituras de conforto. Nada mais é pedido de você.', id: 'Ayat-ayat penghiburan. Tidak ada yang lain diminta dari Anda.' },
  path_comfort_cta: { en: 'Open comfort', es: 'Abrir consuelo', pt: 'Abrir conforto', id: 'Buka penghiburan' },
  path_short_new: { en: "I'm new", es: 'Soy nuevo', pt: 'Sou novo', id: 'Saya baru' },
  path_short_member: { en: 'Member', es: 'Miembro', pt: 'Membro', id: 'Anggota' },
  path_short_study: { en: 'Study', es: 'Estudio', pt: 'Estudo', id: 'Studi' },
  path_short_leader: { en: 'Pastor', es: 'Pastor', pt: 'Pastor', id: 'Pendeta' },
  path_short_comfort: { en: 'Comfort', es: 'Consuelo', pt: 'Conforto', id: 'Penghiburan' },
  path_swatch_label: { en: 'Your path. Change it any time', es: 'Tu camino. Cámbialo cuando quieras', pt: 'Seu caminho. Mude quando quiser', id: 'Jalur Anda. Ubah kapan saja' },
  path_change_btn: { en: 'Change path', es: 'Cambiar camino', pt: 'Mudar caminho', id: 'Ubah jalur' },
  path_landing_prompt: { en: 'Not new to faith?', es: '¿No eres nuevo en la fe?', pt: 'Não é novo na fé?', id: 'Bukan baru dalam iman?' },
  path_landing_link: { en: 'Choose your path', es: 'Elige tu camino', pt: 'Escolha seu caminho', id: 'Pilih jalur Anda' },
  path_ask_title: { en: 'Day 1, done.', es: 'Día 1, hecho.', pt: 'Dia 1, feito.', id: 'Hari 1, selesai.' },
  path_ask_body: { en: 'The 40-day journey is built for someone new to faith or coming back to it. Is that you?', es: 'El camino de 40 días está hecho para alguien nuevo en la fe o que está volviendo. ¿Eres tú?', pt: 'A jornada de 40 dias foi feita para quem é novo na fé ou está voltando. É você?', id: 'Perjalanan 40 hari ini dibuat untuk seseorang yang baru dalam iman atau sedang kembali. Apakah itu Anda?' },
  path_ask_yes: { en: 'Yes, keep going', es: 'Sí, continuar', pt: 'Sim, continuar', id: 'Ya, lanjutkan' },
  path_ask_other: { en: "I'm here for something else", es: 'Estoy aquí por otra cosa', pt: 'Estou aqui por outra coisa', id: 'Saya di sini untuk hal lain' },
  path_ask_eyebrow: { en: 'Asked once · Never again', es: 'Se pregunta una vez · Nunca más', pt: 'Perguntado uma vez · Nunca mais', id: 'Ditanya sekali · Tidak lagi' },
  commentary_ai_label: { en: 'AI insight, not a published commentary', es: 'Perspectiva de IA, no es un comentario publicado', pt: 'Ideia da IA, não é um comentário publicado', id: 'Wawasan AI, bukan tafsiran yang diterbitkan' },
  commentary_ai_none: { en: 'No commentary in the library covers this chapter yet. This is the assistant, not a source.', es: 'Aún ningún comentario de la biblioteca cubre este capítulo. Esto es el asistente, no una fuente.', pt: 'Ainda nenhum comentário da biblioteca cobre este capítulo. Isto é o assistente, não uma fonte.', id: 'Belum ada tafsiran di pustaka yang membahas pasal ini. Ini adalah asisten, bukan sumber.' },
  commentary_empty: { en: 'No commentary for this chapter yet. The other tabs still work.', es: 'Aún no hay comentario para este capítulo. Las otras pestañas siguen funcionando.', pt: 'Ainda não há comentário para este capítulo. As outras abas continuam funcionando.', id: 'Belum ada tafsiran untuk pasal ini. Tab lainnya tetap berfungsi.' },
  commentary_loading: { en: 'Loading commentary', es: 'Cargando comentario', pt: 'Carregando comentário', id: 'Memuat tafsiran' },
  commentary_offline: { en: 'Commentary needs a connection. The chapter is still here.', es: 'El comentario necesita conexión. El capítulo sigue aquí.', pt: 'O comentário precisa de conexão. O capítulo continua aqui.', id: 'Tafsiran memerlukan koneksi. Pasalnya tetap ada di sini.' },
  commentary_where_from: { en: 'Where this comes from', es: 'De dónde viene esto', pt: 'De onde isto vem', id: 'Dari mana ini berasal' },
  commentary_curated_source: { en: 'Daily Word editors', es: 'Editores de Daily Word', pt: 'Editores da Daily Word', id: 'Editor Daily Word' },
  commentary_fetch_failed: { en: 'Could not load this commentary right now. The other tabs still work.', es: 'No se pudo cargar este comentario en este momento. Las otras pestañas siguen funcionando.', pt: 'Não foi possível carregar este comentário agora. As outras abas continuam funcionando.', id: 'Tidak dapat memuat tafsiran ini saat ini. Tab lainnya tetap berfungsi.' },
  commentary_ai_failed: { en: 'The AI insight is not available right now.', es: 'La perspectiva de IA no está disponible en este momento.', pt: 'A ideia da IA não está disponível agora.', id: 'Wawasan AI tidak tersedia saat ini.' },
  commentary_verses_label: { en: 'Verses {range}', es: 'Versículos {range}', pt: 'Versículos {range}', id: 'Ayat {range}' },
  prov_share_alike: { en: 'anything built from it stays under the same licence', es: 'todo lo que se construya a partir de esto permanece bajo la misma licencia', pt: 'tudo o que for construído a partir disso permanece sob a mesma licença', id: 'apa pun yang dibuat darinya tetap berada di bawah lisensi yang sama' },
  prov_ai_author: { en: 'generated for Daily Word, not a published source', es: 'generado para Daily Word, no es una fuente publicada', pt: 'gerado para o Daily Word, não é uma fonte publicada', id: 'dihasilkan untuk Daily Word, bukan sumber yang diterbitkan' },
  prov_curated_note: { en: 'written for Daily Word, not a published commentary', es: 'escrito para Daily Word, no es un comentario publicado', pt: 'escrito para o Daily Word, não é um comentário publicado', id: 'ditulis untuk Daily Word, bukan tafsiran yang diterbitkan' },
  prov_source_unknown: { en: 'Source not recorded', es: 'Fuente no registrada', pt: 'Fonte não registrada', id: 'Sumber tidak tercatat' },
  prov_dw_inline_dictionary: { en: 'Daily Word inline dictionary', es: 'Diccionario integrado de Daily Word', pt: 'Dicionário embutido do Daily Word', id: 'Kamus bawaan Daily Word' },
  prov_bdbt: { en: 'Brown-Driver-Briggs and Thayer, via bolls.life', es: 'Brown-Driver-Briggs y Thayer, vía bolls.life', pt: 'Brown-Driver-Briggs e Thayer, via bolls.life', id: 'Brown-Driver-Briggs dan Thayer, melalui bolls.life' },
  crossrefs_loading: { en: 'Loading cross-references', es: 'Cargando referencias cruzadas', pt: 'Carregando referências cruzadas', id: 'Memuat referensi silang' },
  crossrefs_more: { en: 'more', es: 'más', pt: 'mais', id: 'lainnya' },
  study_sources_scripture_note: { en: 'Scripture text always comes from the Bible text itself. The AI never writes it.', es: 'El texto bíblico siempre proviene del texto bíblico mismo. La IA nunca lo escribe.', pt: 'O texto bíblico sempre vem do próprio texto bíblico. A IA nunca o escreve.', id: 'Teks Alkitab selalu berasal dari teks Alkitab itu sendiri. AI tidak pernah menulisnya.' },
  study_sources_failed: { en: 'Could not load the source list. It will be here next time.', es: 'No se pudo cargar la lista de fuentes. Estará aquí la próxima vez.', pt: 'Não foi possível carregar a lista de fontes. Estará aqui na próxima vez.', id: 'Tidak dapat memuat daftar sumber. Akan ada di sini lain kali.' },
  ai_pastor_framing: { en: 'A study assistant, not a ghostwriter. It finds the sources and shows you where they came from. You write the message.', es: 'Un asistente de estudio, no un escritor fantasma. Encuentra las fuentes y te muestra de dónde vienen. Tú escribes el mensaje.', pt: 'Um assistente de estudo, não um ghostwriter. Ele encontra as fontes e mostra de onde vieram. Você escreve a mensagem.', id: 'Asisten studi, bukan penulis bayangan. Ia menemukan sumbernya dan menunjukkan asalnya. Anda yang menulis pesannya.' },
  ai_teaser_new_title: { en: 'New here? Ask Bible AI anything', es: '¿Nuevo aquí? Pregúntale a Bible AI lo que sea', pt: 'Novo por aqui? Pergunte qualquer coisa ao Bible AI', id: 'Baru di sini? Tanyakan apa saja kepada Bible AI' },
  ai_teaser_new_sub: { en: "Not sure what this passage means? Tap here, it's like having a friend who knows the Bible really well.", es: '¿No sabes qué significa este pasaje? Toca aquí, es como tener un amigo que conoce muy bien la Biblia.', pt: 'Não sabe o que esta passagem significa? Toque aqui, é como ter um amigo que conhece muito bem a Bíblia.', id: 'Tidak yakin apa arti bagian ini? Ketuk di sini, seperti memiliki teman yang sangat mengenal Alkitab.' },
  ai_teaser_cong_title: { en: 'Go deeper with Bible AI', es: 'Profundiza con Bible AI', pt: 'Aprofunde-se com o Bible AI', id: 'Perdalam dengan Bible AI' },
  ai_teaser_cong_sub: { en: "Ask questions about today's reading, get historical context, or explore how it applies to your life.", es: 'Haz preguntas sobre la lectura de hoy, obtén contexto histórico o explora cómo se aplica a tu vida.', pt: 'Faça perguntas sobre a leitura de hoje, obtenha contexto histórico ou explore como ela se aplica à sua vida.', id: 'Ajukan pertanyaan tentang bacaan hari ini, dapatkan konteks sejarah, atau jelajahi bagaimana hal itu berlaku bagi hidup Anda.' },
  ai_teaser_comfort_title: { en: "Talk to Bible AI about what you're feeling", es: 'Habla con Bible AI sobre lo que sientes', pt: 'Converse com o Bible AI sobre o que você está sentindo', id: 'Bicarakan dengan Bible AI tentang apa yang Anda rasakan' },
  ai_teaser_comfort_sub: { en: 'You can ask anything, even the hard questions. Bible AI responds with compassion and Scripture.', es: 'Puedes preguntar cualquier cosa, incluso las preguntas difíciles. Bible AI responde con compasión y Escritura.', pt: 'Você pode perguntar qualquer coisa, até as perguntas difíceis. O Bible AI responde com compaixão e Escritura.', id: 'Anda dapat bertanya apa saja, bahkan pertanyaan sulit. Bible AI menjawab dengan belas kasih dan Firman.' },
  ai_teaser_study_title: { en: 'Explore the original languages', es: 'Explora los idiomas originales', pt: 'Explore os idiomas originais', id: 'Jelajahi bahasa asli' },
