...
const UI: Translations = {
  ...
  // \u2500\u2500 PASTOR ACCOUNT (in-app staff sign-in, Settings) \u2500\u2500
  pastor_account: { en: 'PASTOR ACCOUNT', es: 'CUENTA DE PASTOR', pt: 'CONTA DE PASTOR', id: 'AKUN PENDETA' },
  pastor_sign_in: { en: 'Sign in as pastor', es: 'Iniciar sesi\u00f3n como pastor', pt: 'Entrar como pastor', id: 'Masuk sebagai pendeta' },
  pastor_sign_in_hint: { en: 'For Futures Church staff. Use your work email and the same password as the staff portal.', es: 'Para el equipo de Futures Church. Usa tu correo de trabajo y la misma contrase\u00f1a que en el portal del equipo.', pt: 'Para a equipe da Futures Church. Use seu e-mail de trabalho e a mesma senha do portal da equipe.', id: 'Untuk staf Futures Church. Gunakan email kerja dan kata sandi yang sama dengan portal staf.' },
  pastor_work_email: { en: 'Work email', es: 'Correo de trabajo', pt: 'E-mail de trabalho', id: 'Email kerja' },
  ...
  pastor_first_visit: { en: 'First time here \u2014 choose a password of at least 10 characters. It also works at the staff portal.', es: 'Primera vez \u2014 elige una contrase\u00f1a de al menos 10 caracteres. Tambi\u00e9n sirve en el portal del equipo.', pt: 'Primeira vez \u2014 escolha uma senha com pelo menos 10 caracteres. Ela tamb\u00e9m funciona no portal da equipe.', id: 'Pertama kali di sini \u2014 pilih kata sandi minimal 10 karakter. Berlaku juga di portal staf.' },
  ...
  pastor_change_email: { en: 'Change', es: 'Cambiar', pt: 'Alterar', id: 'Ubah' },
  pastor_cancel: { en: 'Cancel', es: 'Cancelar', pt: 'Cancelar', id: 'Batal' },
  pastor_not_staff: { en: 'That email is not on the staff list. Use your @futures.church address.', es: 'Ese correo no est\u00e1 en la lista del equipo. Usa tu direcci\u00f3n @futures.church.', pt: 'Esse e-mail n\u00e3o est\u00e1 na lista da equipe. Use seu endere\u00e7o @futures.church.', id: 'Email itu tidak ada di daftar staf. Gunakan alamat @futures.church Anda.' },
  pastor_passwords_mismatch: { en: 'Passwords do not match.', es: 'Las contrase\u00f1as no coinciden.', pt: 'As senhas n\u00e3o coincidem.', id: 'Kata sandi tidak cocok.' },
  pastor_switch_notice: { en: 'This device is signed in as {email}. Signing in as pastor switches it to your staff email, and the notes on this device go with you.', es: 'Este dispositivo tiene la sesi\u00f3n de {email}. Al iniciar como pastor cambiar\u00e1 a tu correo del equipo, y las notas de este dispositivo ir\u00e1n contigo.', pt: 'Este dispositivo est\u00e1 conectado como {email}. Entrar como pastor muda para seu e-mail da equipe, e as notas deste dispositivo v\u00e3o com voc\u00ea.', id: 'Perangkat ini masuk sebagai {email}. Masuk sebagai pendeta akan beralih ke email staf Anda, dan catatan di perangkat ini ikut bersama Anda.' },
  pastor_offline_error: { en: 'Could not reach the server. Check your connection and try again.', es: 'No se pudo conectar con el servidor. Revisa tu conexi\u00f3n e int\u00e9ntalo de nuevo.', pt: 'N\u00e3o foi poss\u00edvel conectar ao servidor. Verifique sua conex\u00e3o e tente novamente.', id: 'Tidak dapat menghubungi server. Periksa koneksi Anda dan coba lagi.' },
  pastor_role_admin: { en: 'Admin', es: 'Admin', pt: 'Admin', id: 'Admin' },
  pastor_role_hub: { en: 'Hub', es: 'Hub', pt: 'Hub', id: 'Hub' },
  pastor_role_campus: { en: 'Campus pastor', es: 'Pastor de sede', pt: 'Pastor de campus', id: 'Pendeta kampus' },
  pastor_role_media: { en: 'Media', es: 'Media', pt: 'M\u00eddia', id: 'Media' },
