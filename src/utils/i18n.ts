...
const UI: Translations = {
  ...
  im_new_to_this: { en: 'New to Faith', es: 'Nuevo en la Fe', pt: 'Novo na F\u00e9', id: 'Baru dalam Iman' },
  ...
  journey_label: { en: 'Journey', es: 'Camino', pt: 'Jornada', id: 'Perjalanan' },
  appearance: { en: 'APPEARANCE', es: 'APARIENCIA', pt: 'APAR\u00caNCIA', id: 'TAMPILAN' },
  start_new_to_faith: { en: 'Start New to Faith', es: 'Comenzar Nuevo en la Fe', pt: 'Come\u00e7ar Novo na F\u00e9', id: 'Mulai Baru dalam Iman' },
  more_from_futures: { en: 'More from Futures', es: 'M\u00e1s de Futures', pt: 'Mais da Futures', id: 'Lainnya dari Futures' },
  day_n_of_40: { en: 'Day {n} of 40', es: 'D\u00eda {n} de 40', pt: 'Dia {n} de 40', id: 'Hari {n} dari 40' },
  change_journey: { en: 'Change journey', es: 'Cambiar camino', pt: 'Mudar jornada', id: 'Ubah perjalanan' },
  persona_new: { en: 'New to Faith', es: 'Nuevo en la Fe', pt: 'Novo na F\u00e9', id: 'Baru dalam Iman' },
  ...
  new_here: { en: 'Ask Bible AI anything', es: 'Pregunta lo que quieras a Biblia IA', pt: 'Pergunte qualquer coisa \u00e0 B\u00edblia IA', id: 'Tanyakan apa saja ke Alkitab AI' },
  ...
  your_faith_journey: { en: 'New to Faith', es: 'Nuevo en la Fe', pt: 'Novo na F\u00e9', id: 'Baru dalam Iman' },
