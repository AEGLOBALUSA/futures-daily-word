...
export const PERSONA_CONFIGS: Record<Persona, PersonaConfig> = {
  ...
  pastor_leader: {
    ...
    journal: {
      ...
      prompts: [
        'What big decision are you seeking God for confirmation on right now?',
        'Who on your team or in your family is on your mind today that needs prayer?',
        'What are you believing God for this coming Sunday?',
        'What is God building through your church right now — and what\'s your next step in it?',
        'Who in your congregation is God putting on your mind to reach out to?',
        'What are you asking God to do in your church over the next 90 days?',
        'As you listened today, what stood out — and how does it connect to what you\'re leading right now?',
        'What\'s one area of your ministry where you need fresh direction from God?',
        'Who on your staff needs to be developed as a leader — and what\'s the first move?',
        'What is God saying to you about the vision for your church right now?',
        'What\'s the one thing that would change everything if God moved in it this week?',
        'Are you making disciple-makers or just running programs? What needs to shift?',
        'What conversation do you need to have this week that you\'ve been putting off?',
        'What did God originally call you to — and how does that connect to where you are today?',
        'What are you praying for your staff team this week?',
      ],
    },
    library: {
      sections: ['essays', 'characters', 'locations', 'timeline', 'word-studies'],
